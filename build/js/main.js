(function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                e.preventDefault();
                formData = new FormData(e.target); // let work = []
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function toggle() {
      ...
      var _loop = function _loop(i) {
        ...
        target.addEventListener('click', function (e) {
          element.classList.toggle('is-active'); // target.classList.toggle('is-active')
    ...
    document.querySelectorAll(".video-preview").forEach(function (preview) {
      var button = preview.querySelector(".video-preview__play");
      var videoSrc = preview.dataset.video;
