...
const build = series(clean, prod, parallel(markup, style, script, image, video, font, localization), parallel(generateSitemap, generateRobots, generateTelegram));
const deploy = series(clean, prod, parallel(markup, style, script, image, video, font, localization), parallel(generateSitemap, generateRobots, generateTelegram), archive);
const development = series(clean, dev, parallel(markup, style, script, image, video, font, localization), serve);
